...
void displayPoint3D();
void displayLine3D();
void sortAscending(vector<Point2D>& p2dVector);
void sortDescending(vector<Point2D>& p2dVector);
void sortAscending1(vector<Point2D>& p2dVector);
void sortDescending1(vector<Point2D>& p2dVector);
void sortAscending2(vector<Point2D>& p2dVector);
void sortDescending2(vector<Point2D>& p2dVector);
...
{ 	
	...
	cout << "Sort Ascending by X-Coodinate" << endl;
	sortAscending(p2dVector);
	cout << endl << endl;
	cout << "Sort Descending by X-Coodinate" << endl;
	sortDescending(p2dVector);

	cout << "Sort Ascending by Y-Coodinate" << endl;
	sortAscending1(p2dVector);
	cout << endl << endl;
	cout << "Sort Descending by Y-Coodinate" << endl;
	sortDescending1(p2dVector);

	cout << "Sort Ascending by Dist Fr Origin" << endl;
	sortAscending2(p2dVector);
	cout << endl << endl;
	cout << "Sort Descending by Dist Fr Origin" << endl;
	sortDescending2(p2dVector);
...
void sortAscending(vector<Point2D>& p2dVector) {
  if (p2dVector.empty()) {
    cout << "[No records to sort, list is empty]" << endl;
...
void sortDescending(vector<Point2D>& p2dVector) {
  if (p2dVector.empty()) {  // Use p2dVector here instead of allRecords
    cout << "[No records to sort, list is empty]" << endl;
    return;  // Exits the function early
  }

  // Sort in descending order based on the X ordinate value
  sort(p2dVector.begin(), p2dVector.end(), [](Point2D& lhs,Point2D& rhs) {
    return lhs.getX() > rhs.getX();
  });
