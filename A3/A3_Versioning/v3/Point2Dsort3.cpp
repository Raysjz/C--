...
// Vector Records
vector<string> allRecords;     // Stores all records
vector<string> uniqueRecords;  // Stores Unique Records , removing duplicates
vector<string>
    outputVector;  // Stores output for file output when printing sorted order
...
void sortMenu(int filter_index, int& sort_index) {
  ...
  if (filter_mode[filter_index] == "Point2D") {
    ...
    switch (choice) {
      case 'a':
        sort_index = 0;      // x-oordinate
        break;
      case 'b':
        sort_index = 1;      // y-oordinate
        break;
      case 'c':
...
void SortAndDisplay(string filterCriteria, string sortCriteria,
  ...
  if (filterCriteria == "Point2D") {
    ...
    if (p3dVector.empty()) {
      ...
      if (sortCriteria == "x-ordinate") {
        if (sortOrder == "ASC") {
          sort(p3dVector.begin(), p3dVector.end(),
    ...
    if (l2dVector.empty()) {
      ...
      if (sortCriteria == "Pt.1") {
        if (sortOrder == "ASC") {
          sort(l2dVector.begin(), l2dVector.end(),
    ...
    if (l3dVector.empty()) {
      ...
      if (sortCriteria == "Pt.1") {
        if (sortOrder == "ASC") {
          sort(l3dVector.begin(), l3dVector.end(),
